...
import featuredImg from "../assets/image2.png";
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
        <div className="lg:w-1/4">
          ...
          <p className="text-base text-tartiary ">
            ...
            sentence, which is often a declarative setence, is called the "topic
            sentence".
          </p>
        </div>
        {/* featured cards */}
            ...
            >
              <div>
                ...
                <h5 className="text-2xl font-semibold text-primary px-5 text-center mt-5">
                  Conventient study shcedule
                </h5>
              </div>
            </div>
            <div
              className="bg-[rgba(255,255,255,0.04)] rounded-[35px] h-96 shadow-3xl p-8 
          flex justify-center items-center hover:-translate-y-4 transition-all duration-300 md:mt-16"
            >
              <div>
                <img src={featuredImg} alt="" />
                <h5 className="text-2xl font-semibold text-primary px-5 text-center mt-5">
